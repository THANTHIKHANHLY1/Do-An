      ...
      <div className="flex-1 p-6 overflow-y-auto bg-linear-to-br from-slate-50/50 via-white/50 to-slate-50/50">
        {history.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <h3 className="text-base font-semibold text-slate-900 mb-2">Bắt đầu cuộc trò chuyện</h3>
            <p className="text-sm text-slate-500">Hãy hỏi tôi bất kỳ điều gì về tài liệu này!</p>
          </div>
        ) : (
