      ...
      >
        <div className="space-y-4">
            <p className="text-sm text-neutral-600">
                Bạn có chắc chắn muốn xóa bài kiểm tra này không?: <span className="font-semibold text-neutral-900">{selectedQuiz?.title || 'this quiz'}</span>? This action cannot be undone.
            </p>
            <div className="flex justify-end gap-2 pt-2">
                <Button
                    type="button"
