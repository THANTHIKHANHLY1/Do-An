...
import { FileText, BookOpen, BrainCircuit, TrendingUp, Clock, Calendar } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-slate-500 text-sm">
            Theo dõi tiến độ học tập và hoạt động của bạn
          </p>
        </div>
        ...
        {/* Study Plan Section - NỔI BẬT */}
        <div className="mb-8">
          <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-3xl p-6 text-white shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-purple-100 text-[15px] leading-relaxed mb-5">
                  AI tạo kế hoạch học chi tiết theo mục tiêu của bạn
                </p>
                
                <div className="flex flex-wrap gap-3">
                  <button
                    onClick={() => window.location.href = '/study-planner'}
                    className="bg-white text-purple-700 px-6 py-3 rounded-2xl font-semibold hover:bg-purple-50 active:bg-purple-100 transition-all text-sm flex items-center gap-2"
                  >
                    + Create New Plan
                  </button>
                  ...
                  <button
                    ...
                    className="border border-white/60 hover:bg-white/10 px-6 py-3 rounded-2xl font-medium transition-all text-sm"
                  >
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          ...
          {dashboardData.recentActivity && (dashboardData.recentActivity.documents.length > 0 || dashboardData.recentActivity.quizzes.length > 0) ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-sm text-slate-600">Hiện chưa có hoạt động gần đây.</p>
              <p className="text-xs text-slate-500 mt-1">Hãy bắt đầu học để thấy tiến trình của bạn ở đây</p>
            </div>
          )}
        </div>
      </div>
