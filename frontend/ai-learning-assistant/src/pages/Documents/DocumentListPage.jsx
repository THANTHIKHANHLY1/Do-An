        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Bắt đầu bằng cách tải lên tài liệu PDF đầu tiên của bạn để bắt đầu học tập
            </p>
            <button
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <p className="text-slate-500 text-sm">
              Quản lý và sắp xếp tài liệu học tập của bạn.
            </p>
          </div>
          {documents.length > 0 && (
          ...
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Thêm tài liệu PDF vào thư viện của bạn
              </p>
            </div>
